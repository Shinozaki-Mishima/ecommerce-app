...
<div class="container mydiv">
    <div class="row">
        ...
        <div class="col-md-4" style="padding-bottom:30px">
            <!-- bbb_deals -->
            <div class="bbb_deals">
                <div class="ribbon ribbon-top-right"><span><?php echo $data["discount_percent"]; ?>% OFF</span></div>
                    ...
                    <div class=" bbb_deals_item">
                        ...
                        <div class="bbb_deals_content">
                            ...
                            <div class="bbb_deals_info_line d-flex flex-row justify-content-start">
                                ...
                                <div class="bbb_deals_item_price ml-auto">$<?php echo $data["product_discount_price"]; ?></div>
                            </div>
                            <div class="available">
